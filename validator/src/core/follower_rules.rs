use domain::{BalancesMap, BigNum, Channel};
...
pub fn is_healthy(channel: &Channel, our: &BalancesMap, approved: &BalancesMap) -> bool {
    // TODO: Move this to config
    let health_threshold_neg: BigNum = (1_000 - 950).into();
...
mod test {
    ...
    fn is_healthy_the_approved_balance_tree_gte_our_accounting_is_healthy() {
        ...
        assert!(is_healthy(&channel, &our, &our));
